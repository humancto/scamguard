...
| Explain why with grounded evidence and a safe action | **Proven for product plumbing** | Extractive spans and deterministic actions in [`src/scamguard/signals.py`](../src/scamguard/signals.py); schema/scanner tests require exact source offsets and SAFE invariants | Measure final category/action quality separately; do not describe deterministic signals as generated reasoning. |
...
| Sub-1B serious specialist | **Partial** | Frozen Qwen3.5-0.8B base revision and stage-2 continuation in [`configs/qwen35-08b-call-robustness-stage2.json`](../configs/qwen35-08b-call-robustness-stage2.json) | The continuation must clear frozen BF16, quantized, and sealed-primary gates. Its predecessor passed 29/39 gates and was rejected. |
