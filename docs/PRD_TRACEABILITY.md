...
| Sub-1B serious specialist | **Partial** | Frozen Qwen3.5-0.8B base revision; rejected 35/39 stage-2 result; split-safe stage-3 correction in [`configs/qwen35-08b-boundary-recovery-stage3.json`](../configs/qwen35-08b-boundary-recovery-stage3.json) | Stage 2 cut complete-call SAFE FPR from 5.69% to 1.56% but missed four frozen gates. Stage 3 must clear BF16, quantized, and sealed-primary gates. |
