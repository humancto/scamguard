...
| [NCSU/FTC PPoNE Robocall Audio Dataset](https://github.com/wspr-ncsu/robocall-audio-dataset/tree/5aa6f3bfa8563ce8c1c75ebf8a2271e6ff6b4272) | 1,432 real-world robocall transcripts | Data public domain per publisher README; documentation CC-BY-ND-4.0 | privacy-normalized, overlap-removed, one representative per near-template family; strong-evidence rows map to SCAM and all other admitted English rows map to UNCERTAIN; no SAFE ground truth is inferred |
...
| [AWS MultiDoGO](https://github.com/awslabs/multi-domain-goal-oriented-dialogues-dataset/tree/baa30639c4b271f394b81443c842193407cdf26d) | 86,719 human-human service roleplays | CDLA-Permissive-1.0 | schema-v23 uses 215 weak-weight human agent turns and 860 state derivatives for fitting, 80 family-disjoint action-calibration families, and held insurance/software states |
