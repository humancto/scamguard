...
| ModernBERT schema v23 + Qwen 0.8B base | rejected routed control | 4.68% test escalation | preserves 100% recall, raises FPR 1.03%→1.32%, and improves calibrated macro F1 0.7519→0.7869; still fails the 0.94 gate |
