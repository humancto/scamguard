...
| ModernBERT schema v23 + Qwen 0.8B base | rejected routed control | 4.68% test escalation; 1.25 GB process peak RSS | fast-path p95 14.85 ms, but routed p95 36.28 ms / p99 187.72 ms; ten batch-shape decision mismatches and 0.7871 runtime macro F1; rejected |
