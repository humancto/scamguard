...
| Human-authored MultiDoGO agent turns | 215 | One action-focused view per admitted fitting family; weak verdict weight 0.25 |
| Controlled synthetic rows | 13,123 | Preserved generators plus grounded state increments |
| **Total** | **22,665** | **9,542 licensed non-synthetic + 13,123 controlled synthetic** |

There are 7,575 action-supervised fitting rows. Synthetic action-state rows use the frozen default
verdict weight 0.25. The 215 original MultiDoGO turns also receive verdict weight 0.25 so their
...
|---|---:|---:|---:|---|
| Fitting | 860 | 215 | 215 | model weights |
...
The shorter shaping made one unresolved state exactly identical across two source families. The
builder removed the complete later four-state family and its paired human turn before partition
materialization. This five-row whole-family control is why the final fitting count is 22,665 rather
than 22,670; no duplicate was relabelled or retained.
...
- 22,665 fitting rows, including 9,542 licensed non-synthetic and 13,123 synthetic rows;
- 3,940 action-state rows checked through compaction, tokenization, and truncation;
...
- processed schema-v23 manifest: `c1a4e4d6e8c52a3d499044857ba785459a4f6c9de5ebf1e7f2a8999466224d1a`
- training JSONL: `b31ae7519b1fffc985a9825301ccacfd6d2603279096b6f102355798e105833b`
...
- experiment configuration: `754f60cd90085082a7ca8df7606fecc9951c2bf1f061ffcdb7bdbfabe9dbd535`
